  ...
  render() {
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={githubImg} alternate="github" redirectURL="https://github.com/mythkapo" />
          <SocialLogo imgURL={mailImg} alternate="mail" redirectURL="mailto:kapo@ualberta.ca" />
          <SocialLogo imgURL={linkedInImg} alternate="linkedin" redirectURL="https://www.linkedin.com/in/kapong/" />
        </SocialMediaIcons>
      </Container>
    );
  }
